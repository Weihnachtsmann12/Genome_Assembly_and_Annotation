...
dat <- fread("/data/users/mrubin/assembly_annotation_course/gene_annotation_directory/assembly.maker.output/final/genespace/orthofinder/Results_Nov15/Comparative_Genomics_Statistics/Statistics_PerSpecies.tsv", header = T, fill = TRUE)
...
orthogroups <- fread("/data/users/mrubin/assembly_annotation_course/gene_annotation_directory/assembly.maker.output/final/genespace/orthofinder/Results_Nov15/Orthogroups/Orthogroups.GeneCount.tsv")
